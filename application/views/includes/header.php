                    ...
                    <div class="top-menu">
                        ...
                        <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <i class="icon-bell"></i>
                                    <span class="badge badge-success"> <?=$dayrescount?> </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="external">
                                        <h3>
                                            <span class="bold"><?=$dayrescount?> reservation</span> need action</h3>
                                        <a href="<?= base_url() ?>reservation">view all</a>
                                    </li>
                                    <li>
                                      <?php if($reservationday > 0) { ?>
                                            <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                                <?php foreach ($reservationday as $res) {  $date = date('d-m-Y', strtotime($res->reservation_application));?>
                                            <li>
                                                    <a href="<?= base_url() ?>reservation/action/<?=$res->reservation_id?>">
                                                        <span class="time"><?php echo $date;?></span>
                                                        <span class="details">
                                                            <span class="label label-sm label-icon label-warning">
                                                                <i class="fa fa-warning"></i>
                                                            </span><?=$res->event_name?> - <?=$res->employee_lastname?></span>
                                                    </a>
                                                </li>
                                        <?php }?>
                                            </ul>
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile"> <?=FULLNAME?> (<?=USERNAME?>) | <?=BUSINESS_NAME?> | <?=EMPLOYEE_TYPE?></span>
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start active open">
                            ...
                            <ul class="sub-menu">
                                 ...
                                 <li <?php if($page == "reservation"){ echo 'class="nav-item start active open"'; } ?> >
                                     <a href="<?= base_url() ?>reservation">
                                         <i class="fa fa-calendar"></i>
                                         <span>Reservation</span> 
                                     </a> 
                                 </li>
                                 <li <?php if($page == "event"){ echo 'class="nav-item start active open"'; } ?> >
                                     <a href="<?= base_url() ?>event">
                                         <i class="fa fa-camera-retro"></i>
                                         <span>Promo Event</span> 
                                     </a> 
                                 </li>
                                 <li <?php if($page == "gallery"){ echo 'class="nav-item start active open"'; } ?> >
                                     <a href="<?= base_url() ?>gallery">
                                         <i class="fa fa-image"></i>
                                         <span>Gallery</span> 
                                     </a> 
                                 </li>
                                 <li <?php if($page == "customer"){ echo 'class="nav-item start active open"'; } ?> >
