                        ...
                        <div class="tab-pane active">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gears"></i>Manual Reservation</div>
                                </div>
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?= base_url() ?>Reservation/add/" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
					                            ...
					                            <?php foreach ($event as $ven) { ?>
							                            <option value="<?=$ven->event_id?>"><?=$ven->event_name?> - <?=$ven->event_package?></option>
							                    <?php } ?>
					                            </select>
                                                </div>
                                            </div>
