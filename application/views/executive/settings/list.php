					...
					<div class="col-md-12" style=" padding-right: 2%; padding-left: 2%;">
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="<?= base_url() ?>executive/editSetting/<?=$row->business_id?>" class="btn btn-default btn-sm">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <img src="<?= base_url() ?>logo/<?=$row->business_logo?>" alt="Business" style="width:200px;height:60px;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static"> <b><?=$row->business_description?></b> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
