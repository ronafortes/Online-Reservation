                    ...
                    <div class="portfolio-content portfolio-4">
                        ...
                        <?php foreach ($image as $row) {?>
                            <div class="cbp-item identity logos col-sm-2">
                                <a href="<?= base_url() ?>events/<?=$row->event_image?>" class="cbp-caption cbp-lightbox" data-title="By: <?=$bus->business_name?>">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="<?= base_url() ?>events/<?=$row->event_image?>" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                                                <div class="cbp-l-caption-title"><?=$bus->business_name?></div>
                                                <div class="cbp-l-caption-desc"><?=$row->event_description?></div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
